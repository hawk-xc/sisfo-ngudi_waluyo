<x-app-layout>
                                        ...
                                        <fieldset class="fieldset">
                                            <label class="w-full input">
                                                ...
                                                <input type="number" placeholder="IMT Lansia, ex. 70" step="0.1"
                                                    ...
                                                    value="{{ old('imt') ?? $pemeriksaan->imt }}" name="imt"
                                                    readonly />
                                            </label>
                                            @if ($errors->first('imt'))
                                            ...
                                            <fieldset class="fieldset">
                                                <label class="w-full input">
                                                    ...
                                                    <input type="number" placeholder="Tensi Sistolik, ex. 130"
                                                        ...
                                                        value="{{ old('tensi_sistolik') ?? $pemeriksaan->tensi_sistolik }}"
                                                        name="tensi_sistolik" />
                                                </label>
                                            ...
                                            <fieldset class="fieldset">
                                                <label class="w-full input">
                                                    ...
                                                    <input type="number" placeholder="Tensi Diastolik, ex. 110"
                                                        ...
                                                        value="{{ old('tensi_diastolik') ?? $pemeriksaan->tensi_diastolik }}"
                                    ...
                                    <div class="flex w-full md:gap-3 md:flex-row max-sm:flex-col">
                                        ...
                                        <div class="flex flex-col w-full gap-2 p-2">
                                            ...
                                            <select class="select select-success" name="analisis_imt">
                                                ...
                                                <option value="normal"
                                                    {{ old('analisis_imt', $pemeriksaan->analisis_imt) == 'normal' ? 'selected' : '' }}>
                                                    Normal</option>
                                                <option value="kurus"
                                                    {{ old('analisis_imt', $pemeriksaan->analisis_imt) == 'kurus' ? 'selected' : '' }}>
                                                    Kurus</option>
                                                <option value="gemuk"
                                                    {{ old('analisis_imt', $pemeriksaan->analisis_imt) == 'gemuk' ? 'selected' : '' }}>
                                                    Gemuk</option>
                                                <option value="obesitas"
                                                    {{ old('analisis_imt', $pemeriksaan->analisis_imt) == 'obesitas' ? 'selected' : '' }}>
                                                    Obesitas</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="flex flex-col w-full gap-2 p-2">
                                            ...
                                            <select class="select select-success" name="analisis_tensi">
                                                ...
                                                <option value="hipotensi"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'hipotensi' ? 'selected' : '' }}>
                                                    Hipotensi (Rendah)</option>
                                                <option value="normal"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'normal' ? 'selected' : '' }}>
                                                    Normal</option>
                                                <option value="prehipertensi"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'prehipertensi' ? 'selected' : '' }}>
                                                    Prehipertensi</option>
                                                <option value="hipertensi_stage1"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'hipertensi_stage1' ? 'selected' : '' }}>
                                                    Hipertensi Stage 1</option>
                                                <option value="hipertensi_stage2"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'hipertensi_stage2' ? 'selected' : '' }}>
                                                    Hipertensi Stage 2</option>
                                                <option value="krisis_hipertensi"
                                                    {{ old('analisis_tensi', $pemeriksaan->analisis_tensi) == 'krisis_hipertensi' ? 'selected' : '' }}>
                                    ...
                                    <div class="flex w-full md:gap-3 md:flex-row max-sm:flex-col">
                                        ...
                                        <div class="flex flex-col w-full gap-2 p-2">
                                            ...
                                            <select class="select select-success" name="healthy_check">
                                                ...
                                                <option value="sehat"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'sehat' ? 'selected' : '' }}>
                                                    Sehat
                                                </option>
                                                <option value="flu"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'flu' ? 'selected' : '' }}>
                                                    Flu /
                                                    Demam Ringan</option>
                                                <option value="batuk_pilek"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'batuk_pilek' ? 'selected' : '' }}>
                                                    Batuk / Pilek</option>
                                                <option value="cedera_ringan"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'cedera_ringan' ? 'selected' : '' }}>
                                                    Cedera Ringan</option>
                                                <option value="kondisi_kronis"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'kondisi_kronis' ? 'selected' : '' }}>
                                                    Kondisi Kronis (Asma/Diabetes)</option>
                                                <option value="perlu_pemeriksaan"
                                                    {{ old('healthy_check', $pemeriksaan->healthy_check ?? '') == 'perlu_pemeriksaan' ? 'selected' : '' }}>
                                        ...
                                        <div class="flex flex-col w-full gap-2 p-2">
                                            ...
                                            <select class="select select-success" name="mentality_check">
                                                ...
                                                <option value="sehat"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'sehat' ? 'selected' : '' }}>
                                                    Sehat
                                                    Mental</option>
                                                <option value="cemas_ringan"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'cemas_ringan' ? 'selected' : '' }}>
                                                    Cemas Ringan</option>
                                                <option value="cemas_berat"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'cemas_berat' ? 'selected' : '' }}>
                                                    Cemas Berat</option>
                                                <option value="depresi_ringan"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'depresi_ringan' ? 'selected' : '' }}>
                                                    Depresi Ringan</option>
                                                <option value="depresi_berat"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'depresi_berat' ? 'selected' : '' }}>
                                                    Depresi Berat</option>
                                                <option value="perlu_konsultasi"
                                                    {{ old('mentality_check', $pemeriksaan->mentality_check ?? '') == 'perlu_konsultasi' ? 'selected' : '' }}>
                                    ...
                                    <div class="flex flex-col gap-2 p-2">
                                        ...
                                        <fieldset class="fieldset">
                                            <textarea name="keterangan"
                                                ...
                                                cols="30" rows="15" placeholder="Keterangan...">{{ old('keterangan', $pemeriksaan->keterangan) }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            var selectedLansiaId = "{{ old('lansia_id', $pemeriksaan->lansia_id) }}";
