                            ...
                            <div action="" class="flex flex-row w-full gap-2 p-5">
                                <div id="gambar" class="flex-1">
                                    <div id="gambar-gizi" class="px-5 mb-3">
                                        <img id="preview-gambar" src="{{ asset('storage/' . $gizi->gambar) }}"
                                            alt="Preview Gambar" style="{{ $gizi->gambar ? '' : 'display: none;' }}"
                                            class="max-w-full" />
                                    </div>
                                    ...
                                    <div class="flex flex-col gap-1 p-2">
                                        ...
                                        <fieldset class="fieldset">
                                            <input type="text" name="jenis_gizi" id="jenis_gizi"
                                                ...
                                                value="{{ old('nama_kegiatan', $gizi->jenis_gizi ?? '') }}">
                                    ...
                                    <div class="flex flex-col gap-2 p-2">
                                        ...
                                        <fieldset class="fieldset">
                                            <input type="text" name="bahan_makanan" id="bahan_makanan"
                                                ...
                                                value="{{ old('bahan_makanan', $gizi->bahan_makanan ?? '') }}">
                                        ...
                                        <fieldset class="fieldset">
                                            <label class="w-full input">
                                                ...
                                                <input type="number" placeholder="berat" step="0.1"
                                                    ...
                                                    value="{{ old('berat', $gizi->berat ?? '') }}" name="berat" />
                                            </label>
                                    ...
                                    <div class="flex flex-col gap-2 p-2">
                                        ...
                                        <fieldset class="fieldset">
                                            <textarea name="keterangan" class="w-full textarea {{ $errors->has('keterangan') ? 'textarea-error' : '' }}"
                                                id="keterangan" cols="30" rows="10" placeholder="Keterangan gizi...">{{ old('keterangan', $gizi->keterangan ?? '-') }}</textarea>
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
